...
the research vessel such as toyo's (\kc{cite}) provide continuous
...
\cite{yoerger00,robi17} and archeology \cite{coleman00}.
...
measure biological productivity) (\kc{cie}) and imagers including
hyper-spectral \cite{sigernes18} and infra-red sensors now available
for integration.
